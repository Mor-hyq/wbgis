          ...
          <div class="table-container">
            <div class="left-container">
              <div class="asset-table">
                <div class="width1 border-right">机坪低点排水区域</div>
                ...
                >
                  <div :key="idx+'low_area'" class="width1 ipt-flex">
                    <span v-if="isRead" class="text">{{ list.low_area }}</span>
                    <el-input v-else v-model="list.low_area" :size="size" />
                  </div>
